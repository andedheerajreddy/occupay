const emails = {
    FORGOT_PASSWORD: (userData) => {
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:middle;" width="100%">
                                  <tr>
                                    <td align="center" style="font-size:0px;padding:10px 25px;padding-top:0;padding-bottom:0px;word-break:break-word;">
                                      <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:11px;line-height:1;text-align:center;color:#000000;"> <span style="font-size: 30px; color: #4390B1;"><b>OCCUPAY</b></span> </div>
                                    </td>
                                  </tr>
                                </table>
                              </div>
        ...
        Use the code below and start enjoying OCCUPAY again by generating a new password.
                                    <br>
                                    <br>
                                    <br>
                                    <p
                      ...
                      <tr>
                        <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                          <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1;text-align:center;color:#000000;"> <span style="font-weight: bold; font-size: 21px; color: #45474e">
                                ...
                                We are very excited to have you with us! Use the code below to verify your email, and start using OCCUPAY!
                                <br>
                                <br>
                                <br>
                                <p
                      ...
                      <tr>
                        <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                          <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1;text-align:center;color:#000000;"> <span style="font-weight: bold; font-size: 21px; color: #45474e">
                                ...
                                We are very excited to have you with us! Use the code URL to verify your email, OCCUPAY!
                                <br>
                                <br>
                                ...
                                <span
                                    ...
                                    Please do not share this code with anyone, Use this PASSKEY to OCCUPAY for Your Skills.
                        </span> </div>
                        </td>
                      </tr>
                    </table>
